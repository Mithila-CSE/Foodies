						...
						<div class="container bg-light p-4">
							...
							<form action="" method="POST">
							 ...
							 <div class="mt-1 pb-2">
								...
								<input type="password" class="form-control shadow-none rounded-pill p-3" name="users_password" class="form-control" placeholder="Enter your password">
								<span class="text-danger"><?php if(isset($_POST['submit'])){ echo $passmsg; }?></span>
							 </div>
							 <div class="mt-1 pb-2">
								<button name="submit" class="btn btn-primary  btn-custom shadow-none p-3 w-100 rounded-pill">Login</button>
							 </div>
							 <div class="mt-1 pb-2">
